...
// ── Existing posts (with full content) ──────────────────────────────────────
const existingPosts: BlogPost[] = [
  {
    slug: "why-ai-chatbots-are-the-new-homepage",
    title: "Why AI Chatbots Are the New Homepage",
    cat: "AI & Business", date: "Apr 10, 2026", read: "5 min read",
    excerpt: "How GPT-powered chatbots are replacing static FAQ pages and increasing customer engagement by 300%.",
    tags: ["AI", "Business"],
    content: `
      <img src="/blog/why-ai-chatbots-are-the-new-homepage-hero.webp" alt="Glowing AI chat interface" class="w-full h-[420px] object-cover rounded-2xl my-8 shadow-[0_8px_32px_rgba(0,0,0,0.4)]" />
  ...
  },
  {
    ...
    cat: "Engineering", date: "Apr 5, 2026", read: "12 min read",
    excerpt: "Lessons from building a custom enterprise resource planning system for a 200-person manufacturing company.",
    tags: ["ERP", "Backend"],
    content: `
      <img src="/blog/building-an-erp-system-from-scratch-hero.webp" alt="Enterprise ERP dashboard" class="w-full h-[420px] object-cover rounded-2xl my-8 shadow-[0_8px_32px_rgba(0,0,0,0.4)]" />
      ...
      <img src="/blog/building-an-erp-system-from-scratch-mid.webp" alt="PostgreSQL schema diagram" class="w-full h-[360px] object-cover rounded-2xl my-8 shadow-[0_8px_32px_rgba(0,0,0,0.4)]" />
      ...
      <p>This allowed us to identify N+1 query problems before they ever reached production. By the time the ERP was rolled out to the factory floor, the tech team had a dashboard that provided a god's-eye view of the entire operation.</p>
  ...
  },
  {
    ...
    cat: "Marketing", date: "Mar 28, 2026", read: "7 min read",
    excerpt: "A data-driven breakdown of how much money UK businesses leave on the table with subpar search optimization.",
    tags: ["SEO", "Marketing"],
    content: `
      <img src="/blog/the-real-cost-of-poor-seo-hero.webp" alt="Google search rankings dropping" class="w-full h-[420px] object-cover rounded-2xl my-8 shadow-[0_8px_32px_rgba(0,0,0,0.4)]" />
      ...
      <p>We recently audited a leading UK tech consultancy. Their site looked incredible, but underneath, it was an SEO disaster. Missing alt tags, enormous unoptimized images, client-side rendered content invisible to older crawler bots, and zero strict hierarchical routing. Based on their industry CPC averages, their lack of organic keyword presence was costing them an estimated <strong>£8,000 per month</strong> in equivalent ad spend just to maintain baseline traffic.</p>
      <h2 class="text-2xl font-bold text-[var(--text-h)] mt-8 mb-4">The Trap of "Good Enough" Performance</h2>
      <p>Before our migration, the client's marketing director believed their site was fast because it loaded quickly on his high-end Macbook connected to fiber internet. But SEO isn't determined by subjective feelings — it's measured by Google's Core Web Vitals. We discovered that on standard mobile networks, their massive unstructured DOM and bulky hero video was causing a Largest Contentful Paint (LCP) of over 6 seconds.</p>
      <h2 class="text-2xl font-bold text-[var(--text-h)] mt-8 mb-4">How We Fixed It</h2>
      <p>We migrated their stack to Next.js using SSR to ensure perfect indexing, implemented automated semantic sitemap generation, and aggressively optimized their Core Web Vitals. We brought the LCP down to 1.2 seconds. Within 90 days, organic traffic increased by 145%.</p>
    `
  },
  {
    slug: "nextjs-vs-remix-vs-astro",
    title: "Next.js vs Remix vs Astro in 2026",
    cat: "Engineering", date: "Mar 20, 2026", read: "10 min read",
    excerpt: "An honest comparison of modern React frameworks — and when you should use each one.",
    tags: ["React", "Frontend"],
    content: `
      <img src="/blog/nextjs-vs-remix-vs-astro-hero.webp" alt="Framework comparison showdown" class="w-full h-[420px] object-cover rounded-2xl my-8 shadow-[0_8px_32px_rgba(0,0,0,0.4)]" />
      ...
      <p>Remix shines in data-heavy dashboard applications. By relying on native web standards and completely eliminating the need for complex global state management, Remix provides an incredibly slick developer experience for CRUD apps.</p>
      ...
      <img src="/blog/nextjs-vs-remix-vs-astro-mid.webp" alt="Framework benchmark chart" class="w-full h-[360px] object-cover rounded-2xl my-8 shadow-[0_8px_32px_rgba(0,0,0,0.4)]" />
  ...
  },
  {
    ...
    cat: "Case Study", date: "Mar 12, 2026", read: "8 min read",
    ...
    content: `
      <img src="/blog/cutting-ecommerce-load-times-hero.webp" alt="Load time speedometer improvement" class="w-full h-[420px] object-cover rounded-2xl my-8 shadow-[0_8px_32px_rgba(0,0,0,0.4)]" />
      <p>In e-commerce, milliseconds equal millions. Amazon famously reported that every 100ms of latency cost them 1% in sales. A UK-based boutique marketplace came to us with a beautiful but sluggish Magento site. Average page load: 5.2 seconds.</p>
      ...
      <p>We migrated the frontend to a headless architecture using <strong>Next.js</strong>. We moved third-party scripts to a Web Worker using Partytown, implemented Next/Image for on-the-fly WebP conversion, and decoupled inventory checks to run client-side after the static product shell loaded.</p>
      <img src="/blog/cutting-ecommerce-load-times-mid.webp" alt="Before and after waterfall chart" class="w-full h-[360px] object-cover rounded-2xl my-8 shadow-[0_8px_32px_rgba(0,0,0,0.4)]" />
      <h2 class="text-2xl font-bold text-[var(--text-h)] mt-8 mb-4">The Result</h2>
  ...
  },
  {
    ...
    cat: "Product", date: "Mar 5, 2026", read: "6 min read",
    excerpt: "How we built a personalized nutrition engine using GPT-4 and why accuracy matters more than speed.",
    tags: ["AI", "SaaS"],
    content: `
      <img src="/blog/ai-diet-planner-behind-the-scenes-hero.webp" alt="AI generating meal plan" class="w-full h-[420px] object-cover rounded-2xl my-8 shadow-[0_8px_32px_rgba(0,0,0,0.4)]" />
      ...
      <p>We solved this by using LLMs strictly for reasoning, not for data retrieval. We built a vast, structured SQL database of verified nutritional ingredients. The system works in three phases:</p>
      <ol class="list-decimal pl-6 my-6 space-y-2">
        ...
        <li><strong>Constraint Solving:</strong> A deterministic backend queries our database to find safe ingredient combinations that hit the macro targets.</li>
        <li><strong>Creative Generation:</strong> GPT-4 is handed the verified ingredients and writes appealing recipes.</li>
      </ol>
      <img src="/blog/ai-diet-planner-behind-the-scenes-mid.webp" alt="Three-step pipeline diagram" class="w-full md:w-1/2 float-right ml-6 mb-4 rounded-xl shadow-lg" />
...
// ── Import new post batches ──────────────────────────────────────────────────
import { posts1 } from "./blogPosts1";
import { posts2 } from "./blogPosts2";
import { posts3 } from "./blogPosts3";
import { posts4 } from "./blogPosts4";
import { posts5 } from "./blogPosts5";

// ── Combined & ordered export (matches blog/page.tsx slug order) ─────────────
export const posts: BlogPost[] = [
  ...posts1,           // rise-of-autonomous-ai-agents … ai-driven-cybersecurity
  ...existingPosts,    // chatbots … ai-diet-planner
  ...posts2,           // migrating-to-postgresql … automating-customer-support
  ...posts3,           // graphql-vs-rest … effective-remote-teams
  ...posts4,           // intro-to-typescript … cybersecurity-basics
  ...posts5,           // state-management … web3-and-blockchain
];
