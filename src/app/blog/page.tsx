...
const posts = [
  { title: "Why AI Chatbots Are the New Homepage", cat: "AI & Business", date: "Apr 10, 2026", read: "5 min read", excerpt: "How GPT-powered chatbots are replacing static FAQ pages and increasing customer engagement by 300%.", tags: ["AI", "Business"] },
  { title: "Building an ERP System from Scratch", cat: "Engineering", date: "Apr 5, 2026", read: "12 min read", excerpt: "Lessons from building a custom enterprise resource planning system for a 200-person manufacturing company.", tags: ["ERP", "Backend"] },
  { title: "The Real Cost of Poor SEO", cat: "Marketing", date: "Mar 28, 2026", read: "7 min read", excerpt: "A data-driven breakdown of how much money UK businesses leave on the table with subpar search optimization.", tags: ["SEO", "Marketing"] },
  { title: "Next.js vs Remix vs Astro in 2026", cat: "Engineering", date: "Mar 20, 2026", read: "10 min read", excerpt: "An honest comparison of modern React frameworks — and when you should use each one.", tags: ["React", "Frontend"] },
  { title: "How We Cut E-commerce Load Times by 70%", cat: "Case Study", date: "Mar 12, 2026", read: "8 min read", excerpt: "A technical deep-dive into performance optimization for a Stripe-powered UK marketplace.", tags: ["Performance", "E-commerce"] },
  { title: "AI Diet Planner: Behind the Scenes", cat: "Product", date: "Mar 5, 2026", read: "6 min read", excerpt: "How we built a personalized nutrition engine using GPT-4 and why accuracy matters more than speed.", tags: ["AI", "SaaS"] },
];
    ...
    <div className="min-h-screen pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-[1000px]">
        ...
        <div className="blog-grid flex flex-col gap-6">
          {posts.map((post, i) => (
            <TiltCard key={i} className="blog-card">
              <GlassCard className="p-7 hover:border-violet-500/30 transition-colors cursor-pointer group">
