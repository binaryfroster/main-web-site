      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-[1320px] relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14 text-sm text-text-muted">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-none bg-[#1a1a1a] border border-[#333333] flex items-center justify-center text-[#888888] hover:bg-[#B8F564] hover:border-[#B8F564] hover:text-[#0d0d0d] transition-all duration-300"
                >
                  {s.icon}
                </a>
              ))}
          ...
          <div>
            ...
            {/* Newsletter */}
            <p className="text-xs text-[var(--text-muted)] mb-2">Get practical AI & automation tips every 2 weeks. No spam, unsubscribe anytime.</p>
            {subscribed ? (
              ...
              <>
                <form onSubmit={handleSubscribe} className="flex">
                  <input
                    ...
                    className="flex-grow bg-[#222222] border border-[#333333] border-r-0 rounded-none px-3 py-2 text-[var(--text-h)] text-sm focus:outline-none focus:border-[#B8F564] focus:shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] transition-all placeholder-[var(--text-hint)]"
                    required
                    disabled={subLoading}
                  />
                  <button
                    type="submit"
                    disabled={subLoading}
                    className="px-4 py-2 bg-[#B8F564] border border-[#B8F564] rounded-none text-[#0d0d0d] font-bold hover:bg-[#a6df5a] transition-colors text-sm disabled:opacity-60 whitespace-nowrap"
                  >
                    {subLoading ? "…" : "Join"}
                  </button>
                </form>
